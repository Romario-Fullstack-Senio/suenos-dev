...
export function LoginForm() {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 card">
      <h1 className="text-2xl font-bold mb-6 text-center text-ink">Iniciar Sesión</h1>
      ...
      <div className="grid grid-cols-2 gap-3">
        <a
          ...
          className="flex items-center justify-center gap-2 px-4 py-2 border border-ink/[0.07] rounded-lg hover:border-primary/50 hover:bg-cloud-100 transition-colors text-sm font-medium text-ink"
        >
      ...
      <p className="mt-6 text-center text-ink-muted">
        ¿No tienes cuenta?{' '}
        <Link href="/auth/registro" className="text-secondary hover:underline">
          Registrarse
        </Link>
      </p>
    </div>
